...
def build_final_result(reviews: dict, statistics_result: dict, representative_sentence_dict: dict, summary: str) -> dict:
    ...
    # crawler의 reviews에서 상품명 저장
    final_result["product_name"] = reviews["product_name"]
    
    # crawler의 reviews에서 평균 별점 저장
    final_result["average_rate"] = reviews["average_review_rate"]
    
    # classifier의 representative_sentence_dict으로부터 감정 별 대표 문장 3개 저장
    ...
    # analyzer의 statistics_result로부터 총점, 상위 속성 점수, 하위 속성 점수 저장
