...
async def analyze_product_review_pipeline(url: str):
    ...
    product_name_ing = {
        "product_name": "파이썬 크롤러가 쇼핑몰에서 긁어온 실제 상품 텍스트명",
        # "product_image": "http://쇼핑몰이미지서버주소/img.jpg"
        # "product_image": "https://cdn.011st.com/11dims/resize/2000x2000/quality/75/11src/product/6944374330/B.webp?747375714"
    }
    ...
    final_result = {**product_name_ing, **llm_texts, **model_metrics}
    return final_result

# 추가 내용
# wait-on 라이브러리가 파이썬 서버의 생존을 확인하고 Node.js를 켜줄 수 있도록 응답을 줌
